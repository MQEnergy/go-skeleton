...
type YfoAdmin struct {
	...
	Password     string `gorm:"column:password;type:varchar(64);default:;NOT NULL;comment:密码" json:"password"`             // 密码
	Phone        string `gorm:"column:phone;type:varchar(16);default:;NOT NULL;comment:手机号" json:"phone"`                  // 手机号
	Avatar       string `gorm:"column:avatar;type:varchar(128);default:;NOT NULL;comment:头像" json:"avatar"`                // 头像
	Salt         string `gorm:"column:salt;type:varchar(32);NOT NULL;comment:密码" json:"salt"`                              // 密码
	RealName     string `gorm:"column:real_name;type:varchar(64);default:;NOT NULL;comment:真实姓名" json:"real_name"`         // 真实姓名
	...
	RoleIds      string `gorm:"column:role_ids;type:varchar(32);default:;NOT NULL;comment:角色IDs" json:"role_ids"`          // 角色IDs
	Status       uint8  `gorm:"column:status;type:tinyint unsigned;default:1;NOT NULL;comment:状态 1：正常 2：禁用" json:"status"` // 状态 1：正常 2：禁用
	CreatedAt    uint64 `gorm:"column:created_at;type:bigint unsigned;default:0;NOT NULL;" json:"created_at"`
	UpdatedAt    uint64 `gorm:"column:updated_at;type:bigint unsigned;default:0;NOT NULL;" json:"updated_at"`
}
